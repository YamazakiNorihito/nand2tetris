...
type IToken interface {
	...
	IsObjectMethodCall(nextToken IToken) bool
	IsOp() bool
	IsUnaryOp() bool
}
...
// is object method call ex)`obj.method()`-> true
func (t *Token) IsObjectMethodCall(nextToken IToken) bool {
	return t.IsIdentifier() && nextToken != nil && nextToken.IsDot()
}
